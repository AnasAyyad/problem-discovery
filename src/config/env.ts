...
const envSchema = z.object({
  ...
  DISCOVERY_KEYWORDS: z.string().default('spreadsheet,manual process,inventory,reconciliation,procurement,approval workflow'),
  HN_SEARCH_TERMS: z.string().optional(),
